<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    @if (Auth::user()->role == 1)
        ...
        @if (Auth::user()->role == 1 || Auth::user()->role == 2 || Auth::user()->role == 3)
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'list-guru.index' ? 'active' : '' }}" href="{{ route('list-guru.index') }}">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'list-siswa.index' ? 'active' : '' }}" href="{{ route('list-siswa.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        @endif
            ...
            @if (Auth::user()->role == 2 || Auth::user()->role == 3 || Auth::user()->role == 4)
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'bulanan.index' ? 'active' : '' }}" href="{{ route('bulanan.index') }}">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
